...
#Loxberry Home Verzeichnis, normalerweise /opt/loxberry
my  $home = File::HomeDir->my_home;
#Pfad zur Raumserver config, normalerweise /opt/loxberry/data/plugins/raumserver/node_modules/node-raumserver/config
